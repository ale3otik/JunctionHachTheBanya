    ...
    export default {
        ...
        methods: {
            updateGradients(chartData) {
                ...
                // const gradientStrokeLine = ctx.createLinearGradient(0, 230, 0, 50);
                //
                // gradientStrokeLine.addColorStop(this.gradientStops[0], this.gradientColors[3]);
                // gradientStrokeLine.addColorStop(this.gradientStops[1], this.gradientColors[4]);
                // gradientStrokeLine.addColorStop(this.gradientStops[2], this.gradientColors[5]);
                // chartData.datasets.forEach(set => {
                //     set.borderColor = gradientStroke;
                // });
            }
        },
        mounted() {
